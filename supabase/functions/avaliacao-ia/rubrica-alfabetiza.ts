...
export function normalizeNivel(value: unknown, niveisValidos: string[]): string | null {
  ...
  const found = niveisValidos.find((nivel) => nivel.toLowerCase() === trimmed.toLowerCase());
